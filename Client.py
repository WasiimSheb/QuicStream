...
class QUICClient:
    ...
    def connect(self, host, port):
        ...
        self.create_socket()
        self.socket.set_address((host, port))
        dest_id = Packets.generate_random_hex()
        self.socket.set_dest_cid(dest_id)
        qlh = Packets.QUICLongHeader(Packets.LONG_HEADER_FLAG,dest_id, '', 1)
        self.send_packet(qlh)
